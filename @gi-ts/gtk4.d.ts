...
export const ACCESSIBLE_ATTRIBUTE_BACKGROUND: string;
export const ACCESSIBLE_ATTRIBUTE_FAMILY: string;
export const ACCESSIBLE_ATTRIBUTE_FOREGROUND: string;
export const ACCESSIBLE_ATTRIBUTE_OVERLINE: string;
export const ACCESSIBLE_ATTRIBUTE_OVERLINE_NONE: string;
export const ACCESSIBLE_ATTRIBUTE_OVERLINE_SINGLE: string;
export const ACCESSIBLE_ATTRIBUTE_SIZE: string;
export const ACCESSIBLE_ATTRIBUTE_STRETCH: string;
export const ACCESSIBLE_ATTRIBUTE_STRETCH_CONDENSED: string;
export const ACCESSIBLE_ATTRIBUTE_STRETCH_EXPANDED: string;
export const ACCESSIBLE_ATTRIBUTE_STRETCH_EXTRA_CONDENSED: string;
export const ACCESSIBLE_ATTRIBUTE_STRETCH_EXTRA_EXPANDED: string;
export const ACCESSIBLE_ATTRIBUTE_STRETCH_NORMAL: string;
export const ACCESSIBLE_ATTRIBUTE_STRETCH_SEMI_CONDENSED: string;
export const ACCESSIBLE_ATTRIBUTE_STRETCH_SEMI_EXPANDED: string;
export const ACCESSIBLE_ATTRIBUTE_STRETCH_ULTRA_CONDENSED: string;
export const ACCESSIBLE_ATTRIBUTE_STRETCH_ULTRA_EXPANDED: string;
export const ACCESSIBLE_ATTRIBUTE_STRIKETHROUGH: string;
export const ACCESSIBLE_ATTRIBUTE_STYLE: string;
export const ACCESSIBLE_ATTRIBUTE_STYLE_ITALIC: string;
export const ACCESSIBLE_ATTRIBUTE_STYLE_NORMAL: string;
export const ACCESSIBLE_ATTRIBUTE_STYLE_OBLIQUE: string;
export const ACCESSIBLE_ATTRIBUTE_UNDERLINE: string;
export const ACCESSIBLE_ATTRIBUTE_UNDERLINE_DOUBLE: string;
export const ACCESSIBLE_ATTRIBUTE_UNDERLINE_ERROR: string;
export const ACCESSIBLE_ATTRIBUTE_UNDERLINE_NONE: string;
export const ACCESSIBLE_ATTRIBUTE_UNDERLINE_SINGLE: string;
export const ACCESSIBLE_ATTRIBUTE_VARIANT: string;
export const ACCESSIBLE_ATTRIBUTE_VARIANT_ALL_PETITE_CAPS: string;
export const ACCESSIBLE_ATTRIBUTE_VARIANT_ALL_SMALL_CAPS: string;
export const ACCESSIBLE_ATTRIBUTE_VARIANT_PETITE_CAPS: string;
export const ACCESSIBLE_ATTRIBUTE_VARIANT_SMALL_CAPS: string;
export const ACCESSIBLE_ATTRIBUTE_VARIANT_TITLE_CAPS: string;
export const ACCESSIBLE_ATTRIBUTE_VARIANT_UNICASE: string;
export const ACCESSIBLE_ATTRIBUTE_WEIGHT: string;
...
export function disable_portals(): void;
...
export type TextBufferCommitNotify = (
    buffer: TextBuffer,
...
export type WidgetActionActivateFunc = (widget: Widget, action_name: string, parameter?: GLib.Variant | null) => void;
...
export enum AccessibleAnnouncementPriority {
    LOW = 0,
    MEDIUM = 1,
    HIGH = 2,
}
...
export enum AccessibleTextContentChange {
    INSERT = 0,
    REMOVE = 1,
}
...
export enum AccessibleTextGranularity {
    CHARACTER = 0,
    WORD = 1,
    SENTENCE = 2,
    LINE = 3,
...
export enum GraphicsOffloadEnabled {
    ENABLED = 0,
    DISABLED = 1,
}
...
export enum TextBufferNotifyFlags {
    BEFORE_INSERT = 1,
    AFTER_INSERT = 2,
    BEFORE_DELETE = 4,
    AFTER_DELETE = 8,
...
export class Builder extends GObject.Object {
    ...
    extend_with_template(object: GObject.Object, template_type: GObject.GType, buffer: string, length: number): boolean;
...
export class BuilderListItemFactory extends ListItemFactory {
    ...
    static new_from_bytes(scope: BuilderScope | null, bytes: GLib.Bytes | Uint8Array): BuilderListItemFactory;
...
export class CallbackAction extends ShortcutAction {
    ...
    static ["new"](callback: ShortcutFunc): CallbackAction;
}
...
export class CellView extends Widget implements Accessible, Buildable, CellLayout, ConstraintTarget, Orientable {
...
export class CenterBox extends Widget implements Accessible, Buildable, ConstraintTarget, Orientable {
    ...
    get shrink_center_last(): boolean;
    set shrink_center_last(val: boolean);
...
export class ColorChooserWidget extends Widget implements Accessible, Buildable, ColorChooser, ConstraintTarget {
...
export class ColorDialog extends GObject.Object {
    ...
    constructor(properties?: Partial<ColorDialog.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<ColorDialog.ConstructorProperties>, ...args: any[]): void;
...
export class ColorDialogButton extends Widget implements Accessible, Buildable, ConstraintTarget {
    static $gtype: GObject.GType<ColorDialogButton>;

    constructor(properties?: Partial<ColorDialogButton.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<ColorDialogButton.ConstructorProperties>, ...args: any[]): void;
...
export class ColumnView extends Widget implements Accessible, Buildable, ConstraintTarget, Scrollable {
    ...
    get header_factory(): ListItemFactory;
    set header_factory(val: ListItemFactory);
    get model(): SelectionModel;
    set model(val: SelectionModel);
    get reorderable(): boolean;
    set reorderable(val: boolean);
    get row_factory(): ListItemFactory;
    set row_factory(val: ListItemFactory);
    ...
    get sorter(): Sorter;
    get tab_behavior(): ListTabBehavior;
    set tab_behavior(val: ListTabBehavior);
    ...
    scroll_to(pos: number, column: ColumnViewColumn | null, flags: ListScrollFlags, scroll?: ScrollInfo | null): void;
...
export module ColumnViewCell {
    export interface ConstructorProperties extends ListItem.ConstructorProperties {
        [key: string]: any;
        child: Widget;
        focusable: boolean;
        item: GObject.Object;
...
export class ColumnViewCell extends ListItem {
    static $gtype: GObject.GType<ColumnViewCell>;

    constructor(properties?: Partial<ColumnViewCell.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<ColumnViewCell.ConstructorProperties>, ...args: any[]): void;
...
export class ColumnViewRow extends GObject.Object {
    static $gtype: GObject.GType<ColumnViewRow>;

    constructor(properties?: Partial<ColumnViewRow.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<ColumnViewRow.ConstructorProperties>, ...args: any[]): void;

    // Properties
    get accessible_description(): string;
    set accessible_description(val: string);
    get accessible_label(): string;
    set accessible_label(val: string);
    get activatable(): boolean;
    set activatable(val: boolean);
    get focusable(): boolean;
    set focusable(val: boolean);
...
export class ColumnViewSorter extends Sorter {
    ...
    constructor(properties?: Partial<ColumnViewSorter.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<ColumnViewSorter.ConstructorProperties>, ...args: any[]): void;
...
export class ComboBox extends Widget implements Accessible, Buildable, CellEditable, CellLayout, ConstraintTarget {
...
export class CssProvider extends GObject.Object implements StyleProvider {
    ...
    load_from_bytes(data: GLib.Bytes | Uint8Array): void;
...
export class Dialog extends Window implements Accessible, Buildable, ConstraintTarget, Native, Root, ShortcutManager {
...
export class DragIcon extends Widget implements Accessible, Buildable, ConstraintTarget, Native, Root {
    ...
    static get_for_drag(drag: Gdk.Drag): DragIcon;
...
export class DragSource extends GestureSingle {
    ...
    connect(signal: "drag-end", callback: (_source: this, drag: Gdk.Drag, delete_data: boolean) => void): number;
    connect_after(signal: "drag-end", callback: (_source: this, drag: Gdk.Drag, delete_data: boolean) => void): number;
    emit(signal: "drag-end", drag: Gdk.Drag, delete_data: boolean): void;
    connect(signal: "prepare", callback: (_source: this, x: number, y: number) => Gdk.ContentProvider | null): number;
    connect_after(
        signal: "prepare",
...
export class DropDown extends Widget implements Accessible, Buildable, ConstraintTarget {
    ...
    get search_match_mode(): StringFilterMatchMode;
    set search_match_mode(val: StringFilterMatchMode);
    get selected(): number;
...
export class DropTarget extends EventController {
    ...
    connect(signal: "drop", callback: (_source: this, value: GObject.Value, x: number, y: number) => boolean): number;
    connect_after(
        signal: "drop",
    ...
    connect_after(signal: "motion", callback: (_source: this, x: number, y: number) => Gdk.DragAction): number;
    emit(signal: "motion", x: number, y: number): void;
...
export class DropTargetAsync extends EventController {
    ...
    connect(signal: "drop", callback: (_source: this, drop: Gdk.Drop, x: number, y: number) => boolean): number;
    connect_after(signal: "drop", callback: (_source: this, drop: Gdk.Drop, x: number, y: number) => boolean): number;
...
export class EmojiChooser extends Popover implements Accessible, Buildable, ConstraintTarget, Native, ShortcutManager {
...
export class Entry extends Widget implements Accessible, Buildable, CellEditable, ConstraintTarget, Editable {
    ...
    connect_after(signal: "icon-press", callback: (_source: this, icon_pos: EntryIconPosition) => void): number;
    ...
    connect_after(signal: "icon-release", callback: (_source: this, icon_pos: EntryIconPosition) => void): number;
...
export class EventControllerKey extends EventController {
    ...
    connect(signal: "modifiers", callback: (_source: this, state: Gdk.ModifierType) => boolean): number;
    connect_after(signal: "modifiers", callback: (_source: this, state: Gdk.ModifierType) => boolean): number;
    emit(signal: "modifiers", state: Gdk.ModifierType): void;
...
export class FileChooserWidget extends Widget implements Accessible, Buildable, ConstraintTarget, FileChooser {
...
export class FileDialog extends GObject.Object {
    ...
    constructor(properties?: Partial<FileDialog.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<FileDialog.ConstructorProperties>, ...args: any[]): void;
    ...
    open_text_file(parent?: Window | null, cancellable?: Gio.Cancellable | null): Promise<[Gio.File | null, string]>;
    open_text_file(
        parent: Window | null,
        cancellable: Gio.Cancellable | null,
        callback: Gio.AsyncReadyCallback<this> | null
...
export class FileLauncher extends GObject.Object {
    ...
    constructor(properties?: Partial<FileLauncher.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<FileLauncher.ConstructorProperties>, ...args: any[]): void;

    // Properties
    get always_ask(): boolean;
    set always_ask(val: boolean);
    get file(): Gio.File;
    set file(val: Gio.File);
...
export class FilterListModel<A extends GObject.Object = GObject.Object>
    extends GObject.Object
    implements Gio.ListModel<A>, SectionModel<A>
{
...
export class FlowBox extends Widget implements Accessible, Buildable, ConstraintTarget, Orientable {
    ...
    connect(
        signal: "move-cursor",
        callback: (_source: this, step: MovementStep, count: number, extend: boolean, modify: boolean) => boolean
    ): number;
    connect_after(
        signal: "move-cursor",
        callback: (_source: this, step: MovementStep, count: number, extend: boolean, modify: boolean) => boolean
...
export class FontChooserWidget extends Widget implements Accessible, Buildable, ConstraintTarget, FontChooser {
...
export class FontDialog extends GObject.Object {
    ...
    constructor(properties?: Partial<FontDialog.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<FontDialog.ConstructorProperties>, ...args: any[]): void;
...
export class FontDialogButton extends Widget implements Accessible, Buildable, ConstraintTarget {
    static $gtype: GObject.GType<FontDialogButton>;

    constructor(properties?: Partial<FontDialogButton.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<FontDialogButton.ConstructorProperties>, ...args: any[]): void;
...
export class GestureClick extends GestureSingle {
    ...
    connect(
        ...
        callback: (_source: this, x: number, y: number, button: number, sequence: Gdk.EventSequence | null) => void
    ): number;
    connect_after(
        signal: "unpaired-release",
        callback: (_source: this, x: number, y: number, button: number, sequence: Gdk.EventSequence | null) => void
    ): number;
    emit(signal: "unpaired-release", x: number, y: number, button: number, sequence: Gdk.EventSequence | null): void;
...
export class GraphicsOffload extends Widget implements Accessible, Buildable, ConstraintTarget {
    static $gtype: GObject.GType<GraphicsOffload>;

    constructor(properties?: Partial<GraphicsOffload.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<GraphicsOffload.ConstructorProperties>, ...args: any[]): void;

    // Properties
    get black_background(): boolean;
    set black_background(val: boolean);
    get child(): Widget;
    set child(val: Widget);
    get enabled(): GraphicsOffloadEnabled;
    set enabled(val: GraphicsOffloadEnabled);
    ...
    get_black_background(): boolean;
    get_child(): Widget | null;
    get_enabled(): GraphicsOffloadEnabled;
    set_black_background(value: boolean): void;
    set_child(child?: Widget | null): void;
    set_enabled(enabled: GraphicsOffloadEnabled): void;
...
export class GridView extends ListBase implements Accessible, Buildable, ConstraintTarget, Orientable, Scrollable {
...
export class HeaderBar extends Widget implements Accessible, Buildable, ConstraintTarget {
    ...
    get use_native_controls(): boolean;
    set use_native_controls(val: boolean);
    ...
    get_use_native_controls(): boolean;
    pack_end(child: Widget): void;
    pack_start(child: Widget): void;
    remove(child: Widget): void;
    ...
    set_use_native_controls(setting: boolean): void;
...
export abstract class IMContext extends GObject.Object {
    ...
    activate_osk(event?: Gdk.Event | null): boolean;
    ...
    vfunc_activate_osk_with_event(event: Gdk.Event): boolean;
...
export class IconView extends Widget implements Accessible, Buildable, CellLayout, ConstraintTarget, Scrollable {
...
export class Inscription extends Widget implements Accessible, AccessibleText, Buildable, ConstraintTarget {
    static $gtype: GObject.GType<Inscription>;

    constructor(properties?: Partial<Inscription.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<Inscription.ConstructorProperties>, ...args: any[]): void;
    ...
    update_contents(change: AccessibleTextContentChange, start: number, end: number): void;
    update_selection_bound(): void;
    vfunc_get_attributes(offset: number): [boolean, AccessibleTextRange[] | null, string[] | null, string[] | null];
...
export class Label extends Widget implements Accessible, AccessibleText, Buildable, ConstraintTarget {
...
export class LevelBar extends Widget implements Accessible, AccessibleRange, Buildable, ConstraintTarget, Orientable {
...
export class ListBox extends Widget implements Accessible, Buildable, ConstraintTarget {
    ...
    connect(
        signal: "move-cursor",
        callback: (_source: this, step: MovementStep, count: number, extend: boolean, modify: boolean) => void
    ): number;
    connect_after(
        signal: "move-cursor",
        callback: (_source: this, step: MovementStep, count: number, extend: boolean, modify: boolean) => void
    ...
    set_tab_behavior(behavior: ListTabBehavior): void;
    unselect_all(): void;
...
export class ListHeader extends GObject.Object {
    static $gtype: GObject.GType<ListHeader>;

    constructor(properties?: Partial<ListHeader.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<ListHeader.ConstructorProperties>, ...args: any[]): void;
...
export class ListView extends ListBase implements Accessible, Buildable, ConstraintTarget, Orientable, Scrollable {
...
export class MultiSelection<A extends GObject.Object = GObject.Object>
    extends GObject.Object
    implements Gio.ListModel<A>, SectionModel<A>, SelectionModel<A>
{
...
export class Notebook extends Widget implements Accessible, Buildable, ConstraintTarget {
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number;
    emit(id: string, ...args: any[]): void;
    connect(signal: "change-current-page", callback: (_source: this, page: number) => boolean): number;
    connect_after(signal: "change-current-page", callback: (_source: this, page: number) => boolean): number;
    emit(signal: "change-current-page", page: number): void;
    ...
    connect(signal: "focus-tab", callback: (_source: this, tab: NotebookTab) => boolean): number;
    connect_after(signal: "focus-tab", callback: (_source: this, tab: NotebookTab) => boolean): number;
    emit(signal: "focus-tab", tab: NotebookTab): void;
    connect(signal: "move-focus-out", callback: (_source: this, direction: DirectionType) => void): number;
    connect_after(signal: "move-focus-out", callback: (_source: this, direction: DirectionType) => void): number;
    emit(signal: "move-focus-out", direction: DirectionType): void;
    ...
    connect(
        signal: "reorder-tab",
        callback: (_source: this, direction: DirectionType, move_to_last: boolean) => boolean
    ): number;
    connect_after(
        signal: "reorder-tab",
        callback: (_source: this, direction: DirectionType, move_to_last: boolean) => boolean
    ): number;
    emit(signal: "reorder-tab", direction: DirectionType, move_to_last: boolean): void;
    connect(signal: "select-page", callback: (_source: this, move_focus: boolean) => boolean): number;
    connect_after(signal: "select-page", callback: (_source: this, move_focus: boolean) => boolean): number;
    emit(signal: "select-page", move_focus: boolean): void;
...
export class Paned extends Widget implements Accessible, AccessibleRange, Buildable, ConstraintTarget, Orientable {
...
export class Popover extends Widget implements Accessible, Buildable, ConstraintTarget, Native, ShortcutManager {
...
export class PopoverMenu extends Popover implements Accessible, Buildable, ConstraintTarget, Native, ShortcutManager {
    ...
    // Properties
    get flags(): PopoverMenuFlags;
    set flags(val: PopoverMenuFlags);
    get menu_model(): Gio.MenuModel;
    set menu_model(val: Gio.MenuModel);
    ...
    set_flags(flags: PopoverMenuFlags): void;
...
export class PrintDialog extends GObject.Object {
    static $gtype: GObject.GType<PrintDialog>;

    constructor(properties?: Partial<PrintDialog.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<PrintDialog.ConstructorProperties>, ...args: any[]): void;
...
export class ProgressBar
    extends Widget
    implements Accessible, AccessibleRange, Buildable, ConstraintTarget, Orientable
{
...
export class PropertyExpression extends Expression {
    ...
    static ["new"](this_type: GObject.GType, expression: Expression | null, property_name: string): PropertyExpression;
...
export class Range extends Widget implements Accessible, AccessibleRange, Buildable, ConstraintTarget, Orientable {
...
export class Scale extends Range implements Accessible, AccessibleRange, Buildable, ConstraintTarget, Orientable {
...
export class Scrollbar extends Widget implements Accessible, AccessibleRange, Buildable, ConstraintTarget, Orientable {
...
export module Settings {
    export interface ConstructorProperties extends GObject.Object.ConstructorProperties {
        ...
        gtk_show_status_shapes: boolean;
...
export class Settings extends GObject.Object implements StyleProvider {
    ...
    get gtk_font_rendering(): FontRendering;
    set gtk_font_rendering(val: FontRendering);
    ...
    set gtk_show_status_shapes(val: boolean);
...
export class ShortcutsGroup extends Box implements Accessible, Buildable, ConstraintTarget, Orientable {
    ...
    add_shortcut(shortcut: ShortcutsShortcut): void;
...
export class ShortcutsSection extends Box implements Accessible, Buildable, ConstraintTarget, Orientable {
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number;
    emit(id: string, ...args: any[]): void;
    connect(signal: "change-current-page", callback: (_source: this, offset: number) => boolean): number;
    connect_after(signal: "change-current-page", callback: (_source: this, offset: number) => boolean): number;
    emit(signal: "change-current-page", offset: number): void;
    ...
    add_group(group: ShortcutsGroup): void;
    ...
    implements Accessible, Buildable, ConstraintTarget, Native, Root, ShortcutManager
{
    ...
    add_section(section: ShortcutsSection): void;
...
export class SignalListItemFactory extends ListItemFactory {
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number;
    emit(id: string, ...args: any[]): void;
    connect(signal: "bind", callback: (_source: this, object: GObject.Object) => void): number;
    connect_after(signal: "bind", callback: (_source: this, object: GObject.Object) => void): number;
    emit(signal: "bind", object: GObject.Object): void;
    connect(signal: "setup", callback: (_source: this, object: GObject.Object) => void): number;
    connect_after(signal: "setup", callback: (_source: this, object: GObject.Object) => void): number;
    emit(signal: "setup", object: GObject.Object): void;
    connect(signal: "teardown", callback: (_source: this, object: GObject.Object) => void): number;
    connect_after(signal: "teardown", callback: (_source: this, object: GObject.Object) => void): number;
    emit(signal: "teardown", object: GObject.Object): void;
    connect(signal: "unbind", callback: (_source: this, object: GObject.Object) => void): number;
    connect_after(signal: "unbind", callback: (_source: this, object: GObject.Object) => void): number;
...
export class Snapshot extends Gdk.Snapshot {
    ...
    append_fill(path: Gsk.Path, fill_rule: Gsk.FillRule, color: Gdk.RGBA): void;
    append_inset_shadow(
    ...
    append_stroke(path: Gsk.Path, stroke: Gsk.Stroke, color: Gdk.RGBA): void;
    ...
    push_fill(path: Gsk.Path, fill_rule: Gsk.FillRule): void;
    ...
    push_stroke(path: Gsk.Path, stroke: Gsk.Stroke): void;
    ...
    implements Gio.ListModel<A>, SectionModel<A>
{
    ...
    get n_items(): number;
    get pending(): number;
    get section_sorter(): Sorter;
    set section_sorter(val: Sorter);
    get sorter(): Sorter;
    set sorter(val: Sorter);
...
export class SpinButton
    extends Widget
    implements Accessible, AccessibleRange, Buildable, CellEditable, ConstraintTarget, Editable, Orientable
{
...
export class Text extends Widget implements Accessible, AccessibleText, Buildable, ConstraintTarget, Editable {
...
export class TextBuffer extends GObject.Object {
    ...
    add_commit_notify(flags: TextBufferNotifyFlags, commit_notify: TextBufferCommitNotify): number;
...
export class TextView extends Widget implements Accessible, AccessibleText, Buildable, ConstraintTarget, Scrollable {
    ...
    get_visible_offset(): [number, number];
...
export class UriLauncher extends GObject.Object {
    ...
    constructor(properties?: Partial<UriLauncher.ConstructorProperties>, ...args: any[]);
    _init(properties?: Partial<UriLauncher.ConstructorProperties>, ...args: any[]): void;
...
export class Video extends Widget implements Accessible, Buildable, ConstraintTarget {
    ...
    get file(): Gio.File;
    set file(val: Gio.File);
    get graphics_offload(): GraphicsOffloadEnabled;
    set graphics_offload(val: GraphicsOffloadEnabled);
    get loop(): boolean;
    set loop(val: boolean);
    get media_stream(): MediaStream;
    set media_stream(val: MediaStream);
    ...
    set_file(file?: Gio.File | null): void;
    set_filename(filename?: string | null): void;
    set_graphics_offload(enabled: GraphicsOffloadEnabled): void;
    set_loop(loop: boolean): void;
    set_media_stream(stream?: MediaStream | null): void;
    set_resource(resource_path?: string | null): void;
...
export abstract class Widget extends GObject.InitiallyUnowned implements Accessible, Buildable, ConstraintTarget {
...
export class Window extends Widget implements Accessible, Buildable, ConstraintTarget, Native, Root, ShortcutManager {
...
export class AccessibleList {
    static $gtype: GObject.GType<AccessibleList>;

    constructor(accessibles: Accessible[]);
    constructor(copy: AccessibleList);

    // Constructors
    static new_from_array(accessibles: Accessible[]): AccessibleList;
    static new_from_list(list: Accessible[]): AccessibleList;

    // Members
    get_objects(): Accessible[];
}

export class AccessibleTextRange {
    static $gtype: GObject.GType<AccessibleTextRange>;
    ...
    constructor(copy: AccessibleTextRange);
...
export class ScrollInfo {
    static $gtype: GObject.GType<ScrollInfo>;

    constructor();
    constructor(properties?: Partial<{}>);
    constructor(copy: ScrollInfo);
...
export interface AccessibleTextNamespace {
    $gtype: GObject.GType<AccessibleText>;
    prototype: AccessibleTextPrototype;
}
export type AccessibleText = AccessibleTextPrototype;
export interface AccessibleTextPrototype extends Accessible {
    // Members
...
export interface SectionModelNamespace {
    $gtype: GObject.GType<SectionModel>;
    prototype: SectionModelPrototype;
}
export type SectionModel<A extends GObject.Object = GObject.Object> = SectionModelPrototype<A>;
export interface SectionModelPrototype<A extends GObject.Object = GObject.Object> extends Gio.ListModel<A> {
    // Members
