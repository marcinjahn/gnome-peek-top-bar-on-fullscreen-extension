...
import * as Json from "./json1";
import * as Cogl from "./cogl1";
...
export function frame_source_add(
  priority: number,
  fps: number,
...
export function test_add_data_full(
  test_path: string,
  test_func: GLib.TestDataFunc
): void;
export function test_check_actor_at_point(
  stage: Actor,
  point: Point,
  actor: Actor
): [boolean, Actor | null];
export function test_check_color_at_point(
  stage: Actor,
  point: Point,
  color: Color
): [boolean, Color];
...
export function threads_add_frame_source(
  priority: number,
  fps: number,
  func: GLib.SourceFunc
): number;
...
export function value_set_paint_node(
  value: GObject.Value | any,
  node?: PaintNode | null
): void;
export function value_set_shader_float(
  value: GObject.Value | any,
  floats: number[]
): void;
export function value_set_shader_int(
  value: GObject.Value | any,
  ints: number[]
): void;
export function value_set_shader_matrix(
  value: GObject.Value | any,
  matrix: number[]
): void;
...
export class Actor<
  ...
  implements Atk.ImplementorIface, Animatable, Container, Scriptable
{
  ...
  connect(
    signal: "pick",
    callback: (_source: this, color: Color) => void
  ): number;
  connect_after(
    signal: "pick",
    callback: (_source: this, color: Color) => void
  ...
  connect(
    signal: "queue-redraw",
    callback: (_source: this, origin: Actor) => void
  ): number;
  connect_after(
    signal: "queue-redraw",
    callback: (_source: this, origin: Actor) => void
...
export class Alpha extends GObject.InitiallyUnowned implements Scriptable {
  ...
  constructor(
    properties?: Partial<Alpha.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<Alpha.ConstructorProperties>,
...
export class Animator extends GObject.Object implements Scriptable {
  ...
  constructor(
    properties?: Partial<Animator.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<Animator.ConstructorProperties>,
...
export abstract class Behaviour extends GObject.Object implements Scriptable {
  ...
  constructor(
    properties?: Partial<Behaviour.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<Behaviour.ConstructorProperties>,
...
export module BehaviourDepth {
  export interface ConstructorProperties
    extends Behaviour.ConstructorProperties {
    [key: string]: any;
    depth_end: number;
    depth_start: number;
  }
...
export class BehaviourDepth extends Behaviour implements Scriptable {
  ...
  constructor(
    properties?: Partial<BehaviourDepth.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<BehaviourDepth.ConstructorProperties>,
...
export class BehaviourEllipse extends Behaviour implements Scriptable {
  ...
  constructor(
    properties?: Partial<BehaviourEllipse.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<BehaviourEllipse.ConstructorProperties>,
...
export class BehaviourOpacity extends Behaviour implements Scriptable {
  ...
  constructor(
    properties?: Partial<BehaviourOpacity.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<BehaviourOpacity.ConstructorProperties>,
...
export class BehaviourPath extends Behaviour implements Scriptable {
  ...
  constructor(
    properties?: Partial<BehaviourPath.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<BehaviourPath.ConstructorProperties>,
  ...
  connect(
    signal: "knot-reached",
    callback: (_source: this, knot_num: number) => void
  ): number;
  connect_after(
    signal: "knot-reached",
    callback: (_source: this, knot_num: number) => void
...
export class BehaviourRotate extends Behaviour implements Scriptable {
  ...
  constructor(
    properties?: Partial<BehaviourRotate.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<BehaviourRotate.ConstructorProperties>,
...
export class BehaviourScale extends Behaviour implements Scriptable {
  ...
  constructor(
    properties?: Partial<BehaviourScale.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<BehaviourScale.ConstructorProperties>,
...
export class BinLayout extends LayoutManager {
  ...
  get_alignment(
    child?: Actor | null
  ): [BinAlignment | null, BinAlignment | null];
  set_alignment(
    child: Actor | null,
    x_align: BinAlignment,
    y_align: BinAlignment
  ...
  implements Atk.ImplementorIface, Animatable, Container, Scriptable
{
  ...
  // Conflicted with Clutter.Actor.get_layout_manager
  get_layout_manager(...args: never[]): any;
  ...
  implements Atk.ImplementorIface, Animatable, Container, Scriptable
{
  ...
  constructor(
    properties?: Partial<CairoTexture.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<CairoTexture.ConstructorProperties>,
  ...
  connect(
    signal: "draw",
    callback: (_source: this, cr: cairo.Context) => boolean
  ): number;
  connect_after(
    signal: "draw",
    callback: (_source: this, cr: cairo.Context) => boolean
...
export abstract class DeviceManager extends GObject.Object {
  ...
  constructor(
    properties?: Partial<DeviceManager.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<DeviceManager.ConstructorProperties>,
  ...
  connect(
    signal: "device-added",
    callback: (_source: this, device: InputDevice) => void
  ): number;
  connect_after(
    signal: "device-added",
    callback: (_source: this, device: InputDevice) => void
...
export class DragAction extends Action {
  ...
  constructor(
    properties?: Partial<DragAction.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<DragAction.ConstructorProperties>,
...
export class DropAction extends Action {
  ...
  constructor(
    properties?: Partial<DropAction.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<DropAction.ConstructorProperties>,
  ...
  implements Atk.ImplementorIface, Animatable, Container, Scriptable
{
  ...
  constructor(
    properties?: Partial<Group.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<Group.ConstructorProperties>,
...
export class ListModel extends Model implements Scriptable {
  ...
  constructor(
    properties?: Partial<ListModel.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<ListModel.ConstructorProperties>,
...
export abstract class Model extends GObject.Object implements Scriptable {
  ...
  constructor(
    properties?: Partial<Model.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<Model.ConstructorProperties>,
  ...
  connect(
    signal: "row-added",
    callback: (_source: this, iter: ModelIter) => void
  ): number;
  connect_after(
    signal: "row-added",
    callback: (_source: this, iter: ModelIter) => void
  ...
  appendv(columns: number[], values: GObject.Value[]): void;
  ...
  insertv(row: number, columns: number[], values: GObject.Value[]): void;
  prependv(columns: number[], values: GObject.Value[]): void;
...
export abstract class ModelIter extends GObject.Object {
  ...
  constructor(
    properties?: Partial<ModelIter.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<ModelIter.ConstructorProperties>,
  ...
  implements Atk.ImplementorIface, Animatable, Container, Scriptable
{
  ...
  constructor(
    properties?: Partial<Rectangle.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<Rectangle.ConstructorProperties>,
...
export class Score extends GObject.Object {
  ...
  constructor(
    properties?: Partial<Score.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<Score.ConstructorProperties>,
  ...
  connect(
    ...
    callback: (_source: this, timeline: Timeline) => void
  ): number;
  connect_after(
    signal: "timeline-completed",
    callback: (_source: this, timeline: Timeline) => void
  ...
  implements Atk.ImplementorIface, Animatable, Container, Scriptable
{
  ...
  constructor(
    properties?: Partial<ScrollActor.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<ScrollActor.ConstructorProperties>,
...
export class Shader extends GObject.Object {
  ...
  constructor(
    properties?: Partial<Shader.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<Shader.ConstructorProperties>,
  ...
  implements Atk.ImplementorIface, Animatable, Container, Scriptable
{
  ...
  constructor(
    properties?: Partial<Stage.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<Stage.ConstructorProperties>,
...
export class State extends GObject.Object implements Scriptable {
  ...
  constructor(
    properties?: Partial<State.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<State.ConstructorProperties>,
...
export class TableLayout extends LayoutManager {
  ...
  constructor(
    properties?: Partial<TableLayout.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<TableLayout.ConstructorProperties>,
  ...
  implements Atk.ImplementorIface, Animatable, Container, Scriptable
{
  ...
  connect(
    signal: "cursor-event",
    callback: (_source: this, geometry: Geometry) => void
  ): number;
  connect_after(
    signal: "cursor-event",
    callback: (_source: this, geometry: Geometry) => void
  ...
  implements Atk.ImplementorIface, Animatable, Container, Scriptable
{
  ...
  constructor(
    properties?: Partial<Texture.ConstructorProperties>,
    ...args: any[]
  );
  _init(
    properties?: Partial<Texture.ConstructorProperties>,
  ...
  connect(
    ...
    callback: (_source: this, error: GLib.Error) => void
  ): number;
  connect_after(
    signal: "load-finished",
    callback: (_source: this, error: GLib.Error) => void
...
export interface MediaNamespace {
  ...
  prototype: MediaPrototype;
}
export type Media = MediaPrototype;
export interface MediaPrototype extends GObject.Object {
  // Properties
  audio_volume: number;
