...
export function aligned_alloc(
  n_blocks: number,
  n_block_bytes: number,
  alignment: number
): any | null;
export function aligned_alloc0(
  n_blocks: number,
  n_block_bytes: number,
  alignment: number
): any | null;
export function aligned_free(mem?: any | null): void;
export function aligned_free_sized(
  mem: any | null,
  alignment: number,
  size: number
): void;
export function ascii_digit_value(c: number): number;
export function ascii_dtostr(
  buffer: string,
  buf_len: number,
  d: number
): string;
export function ascii_formatd(
  buffer: string,
  buf_len: number,
  format: string,
  d: number
...
export function ascii_string_to_signed(
  str: string,
  base: number,
  min: number,
  max: number
...
export function atomic_int_compare_and_exchange(
  atomic: number,
  oldval: number,
  newval: number
): boolean;
...
export function atomic_int_exchange_and_add(
  atomic: number,
  val: number
): number;
...
export function atomic_pointer_exchange(
  atomic?: any | null,
  newval?: any | null
): any | null;
...
export function base64_decode_inplace(
...
export function byte_array_free(
...
export function canonicalize_filename(
  filename: string,
...
export function datalist_id_remove_multiple(
  datalist: Data,
  keys: Quark[]
): void;
...
export function dataset_foreach(
  dataset_location: any,
  func: DataForeachFunc
): void;
export function dataset_id_get_data(
  dataset_location: any,
  key_id: Quark
): any | null;
export function date_get_days_in_month(
  month: DateMonth,
  year: DateYear
): number;
...
export function date_valid_dmy(
  day: DateDay,
  month: DateMonth,
  year: DateYear
): boolean;
...
export function dpgettext2(
  domain: string | null,
  context: string,
  msgid: string
): string;
export function environ_getenv(
  envp: string[] | null,
  variable: string
): string | null;
...
export function environ_unsetenv(
  envp: string[] | null,
  variable: string
): string[];
...
export function file_set_contents(
  filename: string,
...
export function filename_from_utf8(
  utf8string: string,
  len: number
): [string, number, number];
export function filename_to_uri(
  filename: string,
  hostname?: string | null
): string;
export function filename_to_utf8(
  opsysstring: string,
  len: number
): [string, number, number];
...
export function get_language_names_with_category(
...
export function hash_table_destroy(
  hash_table: { [key: string]: any } | HashTable<any, any>
): void;
...
export function hash_table_remove_all(
  hash_table: { [key: string]: any } | HashTable<any, any>
): void;
...
export function hash_table_size(
  hash_table: { [key: string]: any } | HashTable<any, any>
): number;
...
export function hash_table_steal_all(
  hash_table: { [key: string]: any } | HashTable<any, any>
): void;
...
export function hash_table_unref(
  hash_table: { [key: string]: any } | HashTable<any, any>
): void;
...
export function hook_insert_before(
  hook_list: HookList,
  sibling: Hook | null,
  hook: Hook
): void;
...
export function io_create_watch(
  channel: IOChannel,
  condition: IOCondition
): Source;
export function key_file_error_quark(): Quark;
export function listenv(): string[];
export function locale_from_utf8(
  utf8string: string,
  len: number
): [Uint8Array, number];
export function locale_to_utf8(
  opsysstring: Uint8Array | string
): [string, number, number];
...
export function log_remove_handler(
  log_domain: string,
  handler_id: number
): void;
...
export function log_set_fatal_mask(
  log_domain: string,
...
export function log_structured_array(
  log_level: LogLevelFlags,
  fields: LogField[]
): void;
export function log_variant(
  log_domain: string | null,
  log_level: LogLevelFlags,
  fields: Variant
): void;
...
export function log_writer_default_would_drop(
  log_level: LogLevelFlags,
  log_domain?: string | null
): boolean;
...
export function parse_debug_string(
  string: string | null,
  keys: DebugKey[]
): number;
...
export function regex_check_replacement(
  replacement: string
): [boolean, boolean];
...
export function sequence_insert_before(
  iter: SequenceIter,
  data?: any | null
): SequenceIter;
export function sequence_move(src: SequenceIter, dest: SequenceIter): void;
export function sequence_move_range(
  dest: SequenceIter,
  begin: SequenceIter,
  end: SequenceIter
): void;
export function sequence_range_get_midpoint(
  begin: SequenceIter,
  end: SequenceIter
): SequenceIter;
export function sequence_remove(iter: SequenceIter): void;
export function sequence_remove_range(
  begin: SequenceIter,
  end: SequenceIter
): void;
...
export function set_error_literal(
  domain: Quark,
  code: number,
  message: string
): Error | null;
...
export function shell_parse_argv(
  command_line: string
): [boolean, string[] | null];
...
export function slice_get_config_state(
  ckey: SliceConfig,
  address: number,
  n_values: number
): number;
...
export function source_remove_by_funcs_user_data(
  funcs: SourceFuncs,
  user_data?: any | null
): boolean;
...
export function str_tokenize_and_fold(
  string: string,
  translit_locale: string | null
): [string[], string[]];
export function strcanon(
  string: string,
  valid_chars: string,
  substitutor: number
): string;
...
export function strdelimit(
  string: string,
  delimiters: string | null,
  new_delimiter: number
): string;
...
export function strrstr_len(
  haystack: string,
  haystack_len: number,
  needle: string
): string;
export function strsignal(signum: number): string;
export function strstr_len(
  haystack: string,
  haystack_len: number,
  needle: string
): string;
...
export function test_add_data_func(
  testpath: string,
  test_data: any | null,
  test_func: TestDataFunc
): void;
export function test_add_data_func_full(
  testpath: string,
  test_data: any | null,
  test_func: TestDataFunc
): void;
...
export function test_expect_message(
  log_domain: string | null,
  log_level: LogLevelFlags,
  pattern: string
): void;
...
export function test_rand_double_range(
  range_start: number,
  range_end: number
): number;
...
export function test_trap_fork(
  usec_timeout: number,
...
export function try_malloc0_n(
  n_blocks: number,
  n_block_bytes: number
): any | null;
export function try_malloc_n(
  n_blocks: number,
  n_block_bytes: number
): any | null;
export function try_realloc(mem: any | null, n_bytes: number): any | null;
export function try_realloc_n(
  mem: any | null,
  n_blocks: number,
  n_block_bytes: number
): any | null;
...
export function unichar_fully_decompose(
  ch: number,
  compat: boolean,
  result_len: number
): [number, number];
export function unichar_get_mirror_char(
  ch: number,
  mirrored_ch: number
): boolean;
...
export function unicode_canonical_decomposition(
  ch: number,
  result_len: number
): number;
...
export function unix_signal_add(
  priority: number,
  signum: number,
  handler: SourceFunc
): number;
...
export function uri_resolve_relative(
  base_uri_string: string | null,
  uri_ref: string,
  flags: UriFlags
): string;
...
export function uri_unescape_string(
  escaped_string: string,
  illegal_characters?: string | null
): string | null;
...
export function utf8_find_next_char(
  p: string,
  end?: string | null
): string | null;
...
export function utf8_normalize(
  str: string,
  len: number,
  mode: NormalizeMode
): string | null;
...
export function utf8_substring(
  str: string,
  start_pos: number,
  end_pos: number
): string;
export function utf8_to_ucs4(
  str: string,
  len: number
): [number, number, number];
export function utf8_to_ucs4_fast(str: string, len: number): [number, number];
export function utf8_to_utf16(
  str: string,
  len: number
): [number, number, number];
...
export function variant_parse_error_print_context(
  error: Error,
  source_str: string
): string;
...
export function variant_type_string_scan(
  string: string,
  limit: string | null
): [boolean, string];
...
export type HookCheckMarshaller = (
  hook: Hook,
...
export type RegexEvalCallback = (
  match_info: MatchInfo,
  result: String
) => boolean;
export type ScannerMsgFunc = (
  scanner: Scanner,
  message: string,
  error: boolean
) => void;
export type SequenceIterCompareFunc = (
  a: SequenceIter,
  b: SequenceIter,
  data?: any | null
) => number;
...
export class BookmarkFile {
  ...
  get_application_info(
    uri: string,
    name: string
  ): [boolean, string, number, DateTime | null];
...
export class Error {
  ...
  constructor(
    domain: { new (...args: any[]): Error } | Quark,
    code: number,
    message: string
  );
...
export class OptionContext {
  ...
  set_translate_func(
    func?: TranslateFunc | null,
    destroy_notify?: DestroyNotify | null
  ): void;
...
export function log_structured(
  logDomain: any,
  logLevel: any,
  stringFields: any
): any;
