 ...
 * GLib 2.0
 *
 * Generated from 2.84.4
 */

import * as GObject from "./gobject2";

export const ALLOCATOR_LIST: number;
export const ALLOCATOR_NODE: number;
export const ALLOCATOR_SLIST: number;
export const ALLOC_AND_FREE: number;
export const ALLOC_ONLY: number;
...
export const TEST_OPTION_NONFATAL_ASSERTIONS: string;
export const TEST_OPTION_NO_PRGNAME: string;
...
export const macro__has_attribute_ifunc: number;
export const macro__has_attribute_no_sanitize_address: number;
...
export function assertion_message_cmpint(
    domain: string,
    file: string,
    line: number,
    func: string,
...
export function async_queue_new(): AsyncQueue;
export function async_queue_new_full(item_free_func?: DestroyNotify | null): AsyncQueue;
...
export function atomic_int_compare_and_exchange_full(atomic: number, oldval: number, newval: number): [boolean, number];
...
export function atomic_pointer_add(atomic: any, val: number): never;
export function atomic_pointer_and(atomic: any, val: number): never;
...
export function atomic_pointer_or(atomic: any, val: number): never;
export function atomic_pointer_set(atomic: any, newval?: any | null): void;
export function atomic_pointer_xor(atomic: any, val: number): never;
...
export function blow_chunks(): void;
...
export function byte_array_append(array: Uint8Array | string, data: number, len: number): Uint8Array;
...
export function byte_array_prepend(array: Uint8Array | string, data: number, len: number): Uint8Array;
export function byte_array_ref(array: Uint8Array | string): Uint8Array;
export function byte_array_remove_index(array: Uint8Array | string, index_: number): Uint8Array;
export function byte_array_remove_index_fast(array: Uint8Array | string, index_: number): Uint8Array;
export function byte_array_remove_range(array: Uint8Array | string, index_: number, length: number): Uint8Array;
export function byte_array_set_size(array: Uint8Array | string, length: number): Uint8Array;
export function byte_array_sized_new(reserved_size: number): Uint8Array;
export function byte_array_sort(array: Uint8Array | string, compare_func: CompareFunc): void;
export function byte_array_sort_with_data(array: Uint8Array | string, compare_func: CompareDataFunc): void;
...
export function chmod(filename: string, mode: number): number;
export function clear_error(): void;
export function close(fd: number): boolean;
export function closefrom(lowfd: number): number;
export function compute_checksum_for_bytes(checksum_type: ChecksumType, data: Bytes | Uint8Array): string | null;
export function compute_checksum_for_data(checksum_type: ChecksumType, data: Uint8Array | string): string | null;
...
export function creat(filename: string, mode: number): number;
...
export function error_domain_register(
...
export function error_domain_register_static(
    error_type_name: string,
    error_type_private_size: number,
    error_type_init: ErrorInitFunc,
    error_type_copy: ErrorCopyFunc,
...
export function fopen(filename: string, mode: string): any | null;
...
export function freopen(filename: string, mode: string, stream?: any | null): any | null;
...
export function hash_table_find(
    hash_table: { [key: string]: any } | HashTable<any, any>,
    predicate: HRFunc
): any | null;
export function hash_table_foreach(hash_table: { [key: string]: any } | HashTable<any, any>, func: HFunc): void;
export function hash_table_foreach_remove(
    hash_table: { [key: string]: any } | HashTable<any, any>,
    func: HRFunc
): number;
export function hash_table_foreach_steal(
    hash_table: { [key: string]: any } | HashTable<any, any>,
    func: HRFunc
): number;
...
export function hash_table_ref(hash_table: { [key: string]: any } | HashTable<any, any>): HashTable<any, any>;
...
export function hook_insert_sorted(hook_list: HookList, hook: Hook, func: HookCompareFunc): void;
...
export function list_pop_allocator(): void;
export function list_push_allocator(allocator: Allocator): void;
...
export function log_set_writer_func(func: LogWriterFunc): void;
...
export function log_writer_default_set_debug_domains(domains?: string | null): void;
...
export function log_writer_syslog(
    log_level: LogLevelFlags,
    fields: LogField[],
    user_data?: any | null
): LogWriterOutput;
export function lstat(filename: string, buf: StatBuf): number;
...
export function mem_chunk_info(): void;
...
export function mkdir(filename: string, mode: number): number;
export function mkdir_with_parents(pathname: string, mode: number): number;
export function node_pop_allocator(): void;
export function node_push_allocator(allocator: Allocator): void;
...
export function once_init_enter(location: any): [boolean, any];
export function once_init_enter_impl(location: number): boolean;
export function once_init_enter_pointer(location: any): boolean;
export function once_init_leave(location: any, result: number): any;
export function once_init_leave_pointer(location: any, result?: any | null): void;
...
export function pointer_bit_lock_and_get(address: any, lock_bit: number): never;
export function pointer_bit_lock_mask_ptr(
    ptr: any | null,
    lock_bit: number,
    set: boolean,
    preserve_mask: never,
...
export function pointer_bit_unlock_and_set(address: any, lock_bit: number, ptr: any | null, preserve_mask: never): void;
export function poll(fds: PollFD, nfds: number, timeout: number): number;
export function prefix_error_literal(err: (Error | null) | null, prefix: string): (Error | null) | null;
export function propagate_error(src: Error): Error | null;
export function qsort_with_data(pbase: any, total_elems: number, size: number, compare_func: CompareDataFunc): void;
...
export function ref_string_equal(str1: string, str2: string): boolean;
...
export function rename(oldfilename: string, newfilename: string): number;
export function rmdir(filename: string): number;
export function sequence_foreach_range(begin: SequenceIter, end: SequenceIter, func: Func): void;
...
export function sequence_sort_changed(iter: SequenceIter, cmp_func: CompareDataFunc): void;
export function sequence_sort_changed_iter(iter: SequenceIter, iter_cmp: SequenceIterCompareFunc): void;
...
export function set_prgname_once(prgname: string): boolean;
...
export function slist_pop_allocator(): void;
export function slist_push_allocator(allocator: Allocator): void;
...
export function stat(filename: string, buf: StatBuf): number;
...
export function str_tokenize_and_fold(string: string, translit_locale?: string | null): [string[], string[] | null];
...
export function test_trap_subprocess_with_envp(
    test_path: string | null,
    envp: string[] | null,
    usec_timeout: number,
    test_flags: TestSubprocessFlags
...
export function unichar_get_mirror_char(ch: number): [boolean, number];
...
export function utf8_truncate_middle(string: string, truncate_length: number): string;
...
export function utime(filename: string, utb?: any | null): number;
...
export function variant_type_checked_(type_string: string): VariantType;
...
export type CacheDestroyFunc = (value?: any | null) => void;
export type CacheDupFunc = (value?: any | null) => any | null;
export type CacheNewFunc = (key?: any | null) => any | null;
...
export type CompletionFunc = (item?: any | null) => string;
export type CompletionStrncmpFunc = (s1: string, s2: string, n: number) => number;
...
export type LogFunc = (log_domain: string | null, log_level: LogLevelFlags, message: string) => void;
...
export type SourceFuncsCheckFunc = (source: Source) => boolean;
export type SourceFuncsFinalizeFunc = (source: Source) => void;
export type SourceFuncsPrepareFunc = (source: Source) => boolean;
...
export class UnixPipe {
    static $gtype: GObject.GType<UnixPipe>;

    constructor(copy: UnixPipe);
...
export class Variant<A extends string = any> {
...
export class VariantType<A extends string = any> {
