...
export function type_class_get(type: GType): TypeClass;
export function type_class_peek(type: GType): TypeClass | null;
export function type_class_peek_static(type: GType): TypeClass | null;
export function type_class_ref(type: GType): TypeClass;
export function type_default_interface_get(g_type: GType): TypeInterface;
...
export function type_interface_peek(instance_class: TypeClass, iface_type: GType): TypeInterface | null;
